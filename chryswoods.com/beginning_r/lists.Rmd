...
## Negative indicies and filtering

You can use negative indices to drop elements from a vector. For example:
...
You can drop multiple indices at once, e.g.
...
would print `[1] "blue"`, as we have dropped the items at indices 1 and 2.

You can also filter by passing in a list of logicals (true or false values) 
...
would now print `[1] "red"  "blue"`, as the value `green` is dropped by
`FALSE`, while `red` and `blue` are both selected as `TRUE`.
...
## Further reading
* [Advanced R - Lists](https://adv-r.hadley.nz/vectors-chap.html#lists)
* [Advanced R - Subsetting](https://adv-r.hadley.nz/subsetting.html)
* [Advanced R - Missing Values](https://adv-r.hadley.nz/vectors-chap.html#missing-values)
* [R Language Definition - Lists](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#List-objects) 
* [R Language Definition - Indexing](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#Indexing)
* [R Language Definition - NA](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#NA-handling)
* [R Language Definition - NULL](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#NULL-object)
