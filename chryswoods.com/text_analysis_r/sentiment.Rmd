...
"they skilfully drove backwards around the course". So, when using these
...
of all of the non-stopwords in the Adventures of Sherlock Holmes;
...
this using dplyr's [inner_join](https://dplyr.tidyverse.org/reference/filter-joins.html)
...
for different blocks of the text. One way to do this is to divide the text
