...
It is of course important not to take this concept too far. Hadley WIckham
suggests that you should avoid or break up pipes with more than ten steps as
these can make debugging much harder. Pipes should also be avoided if you have
more than one input or output, or if there is a complex dependency structure. If
an intermediate result has an obvious description that you may want to use
elsewhere then it is often worth breaking the pipe and assigning this to its
own object.
