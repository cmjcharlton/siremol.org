...
and hit return. This will create a vector. You will see this vector appear
in the Environment pane on the top right;

![](images/rstudio07.png)

This pane shows the values of all of the objects that are stored in each
environment, which can be very useful. By default this shows the global
environment, but you can click the drop-down and choose from a list of currently
active environments to view.
