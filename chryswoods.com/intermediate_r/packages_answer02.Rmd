...
From this we can see that the `cor.test` from the base `stats` package is used 
to calculate these correlations. We can get help with `cor.test` by typing
`?cor.test` in the console, e.g.
